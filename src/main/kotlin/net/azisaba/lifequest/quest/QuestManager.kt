...
import net.azisaba.lifequest.domain.quest.model.EndReason as DomainEndReason
import net.azisaba.lifequest.domain.quest.model.Quest as DomainQuest
import net.azisaba.lifequest.domain.quest.model.QuestState as DomainQuestState
import net.azisaba.lifequest.domain.quest.model.QuestType as DomainQuestType
    ...
    constructor(
        ...
        fun startQuest(
            ...
            return when (domainResult) {
                is net.azisaba.lifequest.domain.quest.model.QuestResult.Success -> {
                ...
                is net.azisaba.lifequest.domain.quest.model.QuestResult.Failure -> {
        ...
        private fun toDomainType(type: QuestType): DomainQuestType =
            DomainQuestType(
                ...
                title = type.title,
                icon =
                    net.azisaba.lifequest.domain.data.Icon(
                        type = type.icon.type,
                ...
                location =
                    type.location?.let {
                        net.azisaba.lifequest.domain.data
                            .Location(it.world, it.x, it.y, it.z, it.yaw, it.pitch)
                    },
                giver = type.giver,
                playLimits =
                    net.azisaba.lifequest.domain.quest.model.PlayLimits(
                ...
                acceptConditions =
                    net.azisaba.lifequest.domain.quest.model.AcceptConditions(
                ...
                guides =
                    type.guides.map {
                        net.azisaba.lifequest.domain.quest.model.GameGuide(
                            title = it.title,
                            location =
                                net.azisaba.lifequest.domain.data.Location(
                                    it.location.world,
                                    it.location.x,
                                    it.location.y,
                                    it.location.z,
                ...
                requirements =
                    type.requirements.mapValues { (k, v) ->
                        net.azisaba.lifequest.domain.quest.model
                            .QuestRequirement(k, v.amount)
                    },
                actions =
                    type.actions?.let {
                        net.azisaba.lifequest.domain.action.ActionSet(
                            onFirstComplete =
                                it.onFirstComplete.map { a ->
                                    net.azisaba.lifequest.domain.action.Action(
                                        type =
                                            when (a.type) {
                                                net.azisaba.lifequest.action.ActionType.COMMAND -> net.azisaba.lifequest.domain.action.ActionType.COMMAND
                                                net.azisaba.lifequest.action.ActionType.ITEM_GIVE -> net.azisaba.lifequest.domain.action.ActionType.ITEM_GIVE
                                                net.azisaba.lifequest.action.ActionType.MYTHIC_ITEM_GIVE -> net.azisaba.lifequest.domain.action.ActionType.MYTHIC_ITEM_GIVE
                                                net.azisaba.lifequest.action.ActionType.PVELEVEL_EXP -> net.azisaba.lifequest.domain.action.ActionType.PVELEVEL_EXP
                                            },
                                        material = a.material,
                                        amount = a.amount,
                                        item = a.item,
                ...
                scripts =
                    type.scripts.map {
                        net.azisaba.lifequest.domain.script.Script(
                            trigger = it.trigger,
                            delay = it.delay,
...
private class DomainPartyAdapter(
...
) : net.azisaba.lifequest.domain.party.model.Party {
    ...
    override val invitationSetting: net.azisaba.lifequest.domain.party.model.InvitationSetting
        get() =
            when (bukkitParty.invitationSetting) {
                net.azisaba.lifequest.party.InvitationSetting.LEADER -> net.azisaba.lifequest.domain.party.model.InvitationSetting.LEADER
                net.azisaba.lifequest.party.InvitationSetting.ALL -> net.azisaba.lifequest.domain.party.model.InvitationSetting.ALL
            }
