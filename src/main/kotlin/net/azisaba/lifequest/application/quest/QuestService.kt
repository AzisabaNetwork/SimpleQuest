...
import net.azisaba.lifequest.domain.script.Script as DomainScript
...
private class QuestInstance(
    override val type: net.azisaba.lifequest.domain.quest.model.QuestType,
    playerIds: List<String>,
) : DomainQuest {
    ...
    override val state: QuestState
        get() = _state
    override val progresses: net.azisaba.lifequest.domain.quest.model.Progresses =
