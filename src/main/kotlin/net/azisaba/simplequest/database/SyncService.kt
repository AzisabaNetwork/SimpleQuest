...
class SyncService
    ...
    constructor(
        ...
        private val multiServerConfig: net.azisaba.simplequest.data.MultiServerConfig,
    ) {
        ...
        private val serverId: String = System.getProperty("simplequest.server-id", "local")
