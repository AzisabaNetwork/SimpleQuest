    ...
    FunSpec({
        ...
        context("BackupConfig") {
            test("defaults") {
                ...
                c.directory shouldBe "plugins/SimpleQuest/backups/"
            }
        ...
        context("SimpleQuestConfig") {
            test("defaults") {
                val c = SimpleQuestConfig()
